...
| `ServicoCancelado` | Cliente/Profissional/Admin | Não gera garantia nem libera pagamento normal (INV-032); pode gerar reembolso parcial, regra pendente (B003); **P8** recalcula taxa de cancelamento |
